...
class PlaywrightController:
    ...
    async def get_interactive_rects(self, page: Page) -> Dict[str, InteractiveRegion]:
        ...
        result = cast(
            ...
            await page.evaluate("HALOWebSurfer.getInteractiveRects();"),
        )
    ...
    async def get_visual_viewport(self, page: Page) -> VisualViewport:
        ...
        return visualviewport_from_dict(
            await page.evaluate("HALOWebSurfer.getVisualViewport();")
        )
    ...
    async def get_focused_rect_id(self, page: Page) -> str:
        ...
        try:
            ...
            pass
        result = await page.evaluate("HALOWebSurfer.getFocusedElementId();")
        return str(result)
    ...
    async def get_page_metadata(self, page: Page) -> Dict[str, Any]:
        ...
        try:
            ...
            pass
        result = await page.evaluate("HALOWebSurfer.getPageMetadata();")
        assert isinstance(result, dict)
    ...
    async def get_tabs_information(
        ...
        Returns:
            ...
            Each dictionary contains:
                ...
                - is_controlled (bool): Whether this tab is currently controlled by HALOWebSurfer
        """
