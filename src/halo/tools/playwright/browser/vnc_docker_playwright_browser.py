...
class VncDockerPlaywrightBrowser(
    ...
    def __init__(
        ...
        *,
        ...
        self._hostname = (
            f"halo-app-vnc-browser_{self._playwright_websocket_path}_{self._novnc_port}"
            if inside_docker
            else "127.0.0.1"
        )
        self._docker_name = f"halo-app-vnc-browser_{self._playwright_websocket_path}_{self._novnc_port}"
