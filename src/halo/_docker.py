...
BROWSER_IMAGE_ENV_VAR = "HALO_BROWSER_IMAGE"
PYTHON_IMAGE_ENV_VAR = "HALO_PYTHON_IMAGE"

DOCKER_REGISTRY = "ghcr.io/microsoft"
# The container images are published under the original magentic-ui names on ghcr.io.
# We use them as-is; only the running container names are branded as HALO.
