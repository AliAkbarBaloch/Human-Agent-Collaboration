...
# Ali Akbar Start (Gap 1 — import BaseApprovalGuard to thread it to Orchestrator)
...
class GroupChat(BaseGroupChat, Component[GroupChatConfig]):
    ...
    component_provider_override = "halo.teams.GroupChat"
    ...
    def __init__(
        ...
        *,
        ...
        # Ali Akbar Start (Gap 1 — accept approval_guard to forward to Orchestrator)
        ...
        # Ali Akbar Start (Gap 1 — store approval_guard for use in factory)
    ...
    def _create_group_chat_manager_factory(
        ...
        return lambda: Orchestrator(
            ...
            # Ali Akbar Start (Gap 1 — forward approval_guard to Orchestrator instance)
