...
from ...halo_config import SentinelPlanConfig
...
class OrchestratorConfig(BaseModel):
    ...
    # Ali Akbar End (Gap 1)
    # Ali Akbar Start (Hybrid Gap 1 — LLM-based risk estimation flag)
    hybrid_risk_estimation: bool = True
    # Ali Akbar End (Hybrid Gap 1)
    # Ali Akbar Prompt Injection Start
    # Gates the user-task injection scan (and the LLM/semantic layer within it) —
    # same flag already used for page/file/code/mcp scanning, applied here too.
