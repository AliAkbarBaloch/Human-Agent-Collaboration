...
- details (string): The details field should be the SINGLE instruction the agent will do. 
    * For instance, if the sentinel step is "check the halo-app repo until it has 7k stars", the details field should be "check the number of stars of halo-app repo"
    * If the task requires checking a specific URL, website, or repository, INCLUDE THE FULL URL in the details field. For example: "check the number of stars of https://github.com/halo-ai/halo-app repo" or "check if https://example.com/api/status returns a 200 status code"
...
User request: "Browse to the halo-app GitHub repository a total of 5 times and report the number of stars at each check. Sleep 30 seconds between each check."

Step 1:
- title: "Monitor GitHub repository stars with 5 repeated checks"
- details: "Visit the halo-app GitHub repository and record the star count"
...
User request: "Tell me when there is a new issue in the halo-project/halo repo that is not spam and genuine. Then try to write a summary of the issue."
Step 1:
- title: "Record current issues in halo-project/halo repo"
- details: "List all current open issues in the halo-project/halo GitHub repository
- agent_name: "web_surfer"
Step 2:
- title: "Monitor for new genuine issues in halo-project/halo repo"
- details: "Check for new open issues in the halo-project/halo GitHub repository
- agent_name: "web_surfer"
- step_type: "SentinelPlanStep"
- sleep_duration: 1200
