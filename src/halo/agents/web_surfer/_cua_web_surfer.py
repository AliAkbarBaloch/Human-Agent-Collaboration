...
from ._web_surfer import HALOWebSurfer

# This code has been adapted from https://github.com/openai/openai-cua-sample-app
# Copyright 2025 OpenAI - MIT License


class WebSurferCUA(HALOWebSurfer):
    """A dummy version of HALOWebSurfer that returns static responses for testing and CUA purposes."""
