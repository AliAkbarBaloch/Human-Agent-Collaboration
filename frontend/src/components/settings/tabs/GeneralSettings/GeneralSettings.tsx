        ...
        <Flex vertical gap="small">
          <Flex align="center" justify="space-between" wrap gap="large">
            <Flex align="center" justify="start" gap="small" wrap>
              Allow Replans
              <Tooltip title="When enabled, HALO will automatically replan if the current plan is not working or you change the original request">
                <InfoCircleOutlined className="text-secondary hover:text-primary cursor-help" />
              </Tooltip>
            </Flex>
            <Switch
          ...
          <Flex align="center" justify="space-between" wrap gap="small">
            <Flex align="center" gap="small">
              ...
              <Tooltip title="Controls how HALO retrieves and uses relevant plans from previous sessions">
                <InfoCircleOutlined className="text-secondary hover:text-primary cursor-help" />
              </Tooltip>
            </Flex>
            <Select
